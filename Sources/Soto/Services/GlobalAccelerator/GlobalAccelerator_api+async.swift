...
extension GlobalAccelerator {
    ...
    /// 			attachment.
    public func createCrossAccountAttachment(_ input: CreateCrossAccountAttachmentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateCrossAccountAttachmentResponse {
        return try await self.client.execute(operation: "CreateCrossAccountAttachment", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteCrossAccountAttachment(_ input: DeleteCrossAccountAttachmentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteCrossAccountAttachment", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeCrossAccountAttachment(_ input: DescribeCrossAccountAttachmentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeCrossAccountAttachmentResponse {
        return try await self.client.execute(operation: "DescribeCrossAccountAttachment", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCrossAccountAttachments(_ input: ListCrossAccountAttachmentsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListCrossAccountAttachmentsResponse {
        return try await self.client.execute(operation: "ListCrossAccountAttachments", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// List the accounts that have cross-account endpoints.
    public func listCrossAccountResourceAccounts(_ input: ListCrossAccountResourceAccountsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListCrossAccountResourceAccountsResponse {
        return try await self.client.execute(operation: "ListCrossAccountResourceAccounts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// List the cross-account endpoints available to add to an accelerator.
    public func listCrossAccountResources(_ input: ListCrossAccountResourcesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListCrossAccountResourcesResponse {
        return try await self.client.execute(operation: "ListCrossAccountResources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 			accelerator as a principal, but another cross-account attachment includes the account ID
    /// 			that owns that accelerator, endpoints will not be removed from the accelerator.
    public func updateCrossAccountAttachment(_ input: UpdateCrossAccountAttachmentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateCrossAccountAttachmentResponse {
        return try await self.client.execute(operation: "UpdateCrossAccountAttachment", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
