...
public struct Comprehend: AWSService {
    ...
    public func detectToxicContent(_ input: DetectToxicContentRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectToxicContentResponse> {
        return self.client.execute(operation: "DetectToxicContent", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
