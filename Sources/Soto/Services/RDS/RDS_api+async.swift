...
extension RDS {
    ...
    public func createIntegration(_ input: CreateIntegrationMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Integration {
        return try await self.client.execute(operation: "CreateIntegration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createTenantDatabase(_ input: CreateTenantDatabaseMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateTenantDatabaseResult {
        return try await self.client.execute(operation: "CreateTenantDatabase", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteIntegration(_ input: DeleteIntegrationMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> Integration {
        return try await self.client.execute(operation: "DeleteIntegration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteTenantDatabase(_ input: DeleteTenantDatabaseMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteTenantDatabaseResult {
        return try await self.client.execute(operation: "DeleteTenantDatabase", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDBSnapshotTenantDatabases(_ input: DescribeDBSnapshotTenantDatabasesMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DBSnapshotTenantDatabasesMessage {
        return try await self.client.execute(operation: "DescribeDBSnapshotTenantDatabases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeIntegrations(_ input: DescribeIntegrationsMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeIntegrationsResponse {
        return try await self.client.execute(operation: "DescribeIntegrations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeTenantDatabases(_ input: DescribeTenantDatabasesMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> TenantDatabasesMessage {
        return try await self.client.execute(operation: "DescribeTenantDatabases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func modifyTenantDatabase(_ input: ModifyTenantDatabaseMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ModifyTenantDatabaseResult {
        return try await self.client.execute(operation: "ModifyTenantDatabase", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
