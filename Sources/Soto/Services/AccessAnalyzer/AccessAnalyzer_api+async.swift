...
extension AccessAnalyzer {
    ...
    public func checkAccessNotGranted(_ input: CheckAccessNotGrantedRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CheckAccessNotGrantedResponse {
        return try await self.client.execute(operation: "CheckAccessNotGranted", path: "/policy/check-access-not-granted", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func checkNoNewAccess(_ input: CheckNoNewAccessRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CheckNoNewAccessResponse {
        return try await self.client.execute(operation: "CheckNoNewAccess", path: "/policy/check-no-new-access", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// Retrieves information about the specified finding.
    public func getFindingV2(_ input: GetFindingV2Request, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetFindingV2Response {
        return try await self.client.execute(operation: "GetFindingV2", path: "/findingv2/{id}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// Retrieves a list of findings generated by the specified analyzer. To learn about filter keys that you can use to retrieve a list of findings, see IAM Access Analyzer filter keys in the IAM User Guide.
    public func listFindingsV2(_ input: ListFindingsV2Request, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListFindingsV2Response {
        return try await self.client.execute(operation: "ListFindingsV2", path: "/findingv2", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
