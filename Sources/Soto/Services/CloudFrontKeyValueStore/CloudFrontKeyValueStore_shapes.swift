...
extension CloudFrontKeyValueStore {
    ...
    public struct DeleteKeyRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "kvsARN", location: .uri("KvsARN"))
        ]
    ...
    public struct DescribeKeyValueStoreResponse: AWSDecodableShape {
        ...
        public init(created: Date, eTag: String, itemCount: Int, kvsARN: String, lastModified: Date? = nil, totalSizeInBytes: Int64) {
