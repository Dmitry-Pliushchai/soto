...
public struct CloudTrail: AWSService {
    ...
    public func disableFederation(_ input: DisableFederationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisableFederationResponse> {
        return self.client.execute(operation: "DisableFederation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func enableFederation(_ input: EnableFederationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnableFederationResponse> {
        return self.client.execute(operation: "EnableFederation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
