...
extension FSx {
    ...
    public func copySnapshotAndUpdateVolume(_ input: CopySnapshotAndUpdateVolumeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CopySnapshotAndUpdateVolumeResponse {
        return try await self.client.execute(operation: "CopySnapshotAndUpdateVolume", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeSharedVpcConfiguration(_ input: DescribeSharedVpcConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeSharedVpcConfigurationResponse {
        return try await self.client.execute(operation: "DescribeSharedVpcConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMisconfiguredStateRecovery(_ input: StartMisconfiguredStateRecoveryRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartMisconfiguredStateRecoveryResponse {
        return try await self.client.execute(operation: "StartMisconfiguredStateRecovery", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateSharedVpcConfiguration(_ input: UpdateSharedVpcConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateSharedVpcConfigurationResponse {
        return try await self.client.execute(operation: "UpdateSharedVpcConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
