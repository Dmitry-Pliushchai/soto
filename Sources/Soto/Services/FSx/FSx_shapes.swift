...
extension FSx {
    ...
    public struct CreateFileSystemOntapConfiguration: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.haPairs, name: "haPairs", parent: name, max: 6)
