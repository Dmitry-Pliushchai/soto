...
public struct FSx: AWSService {
    ...
    public func copySnapshotAndUpdateVolume(_ input: CopySnapshotAndUpdateVolumeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopySnapshotAndUpdateVolumeResponse> {
        return self.client.execute(operation: "CopySnapshotAndUpdateVolume", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeSharedVpcConfiguration(_ input: DescribeSharedVpcConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSharedVpcConfigurationResponse> {
        return self.client.execute(operation: "DescribeSharedVpcConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMisconfiguredStateRecovery(_ input: StartMisconfiguredStateRecoveryRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMisconfiguredStateRecoveryResponse> {
        return self.client.execute(operation: "StartMisconfiguredStateRecovery", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateSharedVpcConfiguration(_ input: UpdateSharedVpcConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateSharedVpcConfigurationResponse> {
        return self.client.execute(operation: "UpdateSharedVpcConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
