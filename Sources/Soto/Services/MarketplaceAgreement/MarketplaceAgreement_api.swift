...
public struct MarketplaceAgreement: AWSService {
    ...
    public func describeAgreement(_ input: DescribeAgreementInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAgreementOutput> {
    ...
    public func getAgreementTerms(_ input: GetAgreementTermsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAgreementTermsOutput> {
        return self.client.execute(operation: "GetAgreementTerms", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func searchAgreements(_ input: SearchAgreementsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchAgreementsOutput> {
        return self.client.execute(operation: "SearchAgreements", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
