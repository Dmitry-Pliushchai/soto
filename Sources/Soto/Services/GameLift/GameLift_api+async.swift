...
extension GameLift {
    ...
    public func createLocation(_ input: CreateLocationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateLocationOutput {
        return try await self.client.execute(operation: "CreateLocation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteLocation(_ input: DeleteLocationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteLocationOutput {
    ...
    public func deregisterCompute(_ input: DeregisterComputeInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeregisterComputeOutput {
        return try await self.client.execute(operation: "DeregisterCompute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeCompute(_ input: DescribeComputeInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeComputeOutput {
        return try await self.client.execute(operation: "DescribeCompute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getComputeAccess(_ input: GetComputeAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetComputeAccessOutput {
        return try await self.client.execute(operation: "GetComputeAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getComputeAuthToken(_ input: GetComputeAuthTokenInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetComputeAuthTokenOutput {
        return try await self.client.execute(operation: "GetComputeAuthToken", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCompute(_ input: ListComputeInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListComputeOutput {
        return try await self.client.execute(operation: "ListCompute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listLocations(_ input: ListLocationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListLocationsOutput {
    ...
    public func registerCompute(_ input: RegisterComputeInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RegisterComputeOutput {
        return try await self.client.execute(operation: "RegisterCompute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
