...
public struct WAFV2: AWSService {
    ...
    public func createAPIKey(_ input: CreateAPIKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateAPIKeyResponse> {
        return self.client.execute(operation: "CreateAPIKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeAllManagedProducts(_ input: DescribeAllManagedProductsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAllManagedProductsResponse> {
        return self.client.execute(operation: "DescribeAllManagedProducts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Provides high-level information for the managed rule groups owned by a specific vendor.
    public func describeManagedProductsByVendor(_ input: DescribeManagedProductsByVendorRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeManagedProductsByVendorResponse> {
        return self.client.execute(operation: "DescribeManagedProductsByVendor", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDecryptedAPIKey(_ input: GetDecryptedAPIKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDecryptedAPIKeyResponse> {
        return self.client.execute(operation: "GetDecryptedAPIKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listAPIKeys(_ input: ListAPIKeysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAPIKeysResponse> {
        return self.client.execute(operation: "ListAPIKeys", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
