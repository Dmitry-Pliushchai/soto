...
extension Backup {
    ...
    public struct CreateRestoreTestingSelectionInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "restoreTestingPlanName", location: .uri("RestoreTestingPlanName"))
        ]
    ...
    public struct DeleteRestoreTestingSelectionInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "restoreTestingPlanName", location: .uri("RestoreTestingPlanName")),
            AWSMemberEncoding(label: "restoreTestingSelectionName", location: .uri("RestoreTestingSelectionName"))
        ]
    ...
    public struct GetRestoreTestingInferredMetadataInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "backupVaultAccountId", location: .querystring("BackupVaultAccountId")),
            AWSMemberEncoding(label: "backupVaultName", location: .querystring("BackupVaultName")),
            AWSMemberEncoding(label: "recoveryPointArn", location: .querystring("RecoveryPointArn"))
        ]
    ...
    public struct ListBackupJobSummariesInput: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "aggregationPeriod", location: .querystring("AggregationPeriod")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("MaxResults")),
            AWSMemberEncoding(label: "messageCategory", location: .querystring("MessageCategory")),
    ...
    public struct ListBackupJobsInput: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "byMessageCategory", location: .querystring("messageCategory")),
    ...
    public struct ListRestoreJobsByProtectedResourceInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "byRecoveryPointCreationDateAfter", location: .querystring("recoveryPointCreationDateAfter")),
            AWSMemberEncoding(label: "byRecoveryPointCreationDateBefore", location: .querystring("recoveryPointCreationDateBefore")),
            AWSMemberEncoding(label: "byStatus", location: .querystring("status")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "resourceArn", location: .uri("ResourceArn"))
    ...
    public struct ListRestoreJobsInput: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "byCreatedAfter", location: .querystring("createdAfter")),
            AWSMemberEncoding(label: "byCreatedBefore", location: .querystring("createdBefore")),
            AWSMemberEncoding(label: "byRestoreTestingPlanArn", location: .querystring("restoreTestingPlanArn")),
            AWSMemberEncoding(label: "byStatus", location: .querystring("status")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken"))
        ]
