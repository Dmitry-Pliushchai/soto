...
public struct SSM: AWSService {
    ...
    public func deleteOpsItem(_ input: DeleteOpsItemRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteOpsItemResponse> {
        return self.client.execute(operation: "DeleteOpsItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
