...
public struct VerifiedPermissions: AWSService {
    ...
    public func batchIsAuthorized(_ input: BatchIsAuthorizedInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchIsAuthorizedOutput> {
        return self.client.execute(operation: "BatchIsAuthorized", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
