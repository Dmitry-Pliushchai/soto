...
extension Transcribe {
    ...
    public func deleteMedicalScribeJob(_ input: DeleteMedicalScribeJobRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteMedicalScribeJob", path: "/medicalscribejobs/{MedicalScribeJobName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getMedicalScribeJob(_ input: GetMedicalScribeJobRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetMedicalScribeJobResponse {
        return try await self.client.execute(operation: "GetMedicalScribeJob", path: "/medicalscribejobs/{MedicalScribeJobName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listMedicalScribeJobs(_ input: ListMedicalScribeJobsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListMedicalScribeJobsResponse {
        return try await self.client.execute(operation: "ListMedicalScribeJobs", path: "/medicalscribejobs", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMedicalScribeJob(_ input: StartMedicalScribeJobRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartMedicalScribeJobResponse {
        return try await self.client.execute(operation: "StartMedicalScribeJob", path: "/medicalscribejobs/{MedicalScribeJobName}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
