...
extension AlexaForBusiness {
    ...
    public struct CreateMeetingRoomConfiguration: AWSEncodableShape {
        ...
        public let proactiveJoin: CreateProactiveJoin?
        ...
        public init(endOfMeetingReminder: CreateEndOfMeetingReminder? = nil, instantBooking: CreateInstantBooking? = nil, proactiveJoin: CreateProactiveJoin? = nil, requireCheckIn: CreateRequireCheckIn? = nil, roomUtilizationMetricsEnabled: Bool? = nil) {
    ...
    public struct CreateProactiveJoin: AWSEncodableShape {
        public let enabledByMotion: Bool

        public init(enabledByMotion: Bool) {
    ...
    public struct CreateUserRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.email, name: "email", parent: name, pattern: "^\\w[+-.\\w]*@\\w[\\w\\.\\-]+\\.[0-9a-zA-Z]{2,24}$")
    ...
    public struct MeetingRoomConfiguration: AWSDecodableShape {
        ...
        public let proactiveJoin: ProactiveJoin?
        /// Settings for requiring a check in when a room is reserved. Alexa can cancel a room reservation if it's not checked into. This makes the room available for others. Users can check in by joining the meeting with Alexa or an AVS device, or by saying “Alexa, check in.”
        public let requireCheckIn: RequireCheckIn?
        /// Whether room utilization metrics are enabled or not.
        public let roomUtilizationMetricsEnabled: Bool?

        public init(endOfMeetingReminder: EndOfMeetingReminder? = nil, instantBooking: InstantBooking? = nil, proactiveJoin: ProactiveJoin? = nil, requireCheckIn: RequireCheckIn? = nil, roomUtilizationMetricsEnabled: Bool? = nil) {
            self.endOfMeetingReminder = endOfMeetingReminder
            self.instantBooking = instantBooking
            self.proactiveJoin = proactiveJoin
            self.requireCheckIn = requireCheckIn
    ...
    public struct ProactiveJoin: AWSDecodableShape {
        public let enabledByMotion: Bool?

        public init(enabledByMotion: Bool? = nil) {
            self.enabledByMotion = enabledByMotion
        }
    ...
    public struct PutInvitationConfigurationRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.contactEmail, name: "contactEmail", parent: name, pattern: "^\\w[+-.\\w]*@\\w[\\w\\.\\-]+\\.[0-9a-zA-Z]{2,24}$")
    ...
    public struct UpdateMeetingRoomConfiguration: AWSEncodableShape {
        ...
        public let proactiveJoin: UpdateProactiveJoin?
        /// Settings for requiring a check in when a room is reserved. Alexa can cancel a room reservation if it's not checked into to make the room available for others. Users can check in by joining the meeting with Alexa or an AVS device, or by saying “Alexa, check in.”
        public let requireCheckIn: UpdateRequireCheckIn?
        /// Whether room utilization metrics are enabled or not.
        public let roomUtilizationMetricsEnabled: Bool?

        public init(endOfMeetingReminder: UpdateEndOfMeetingReminder? = nil, instantBooking: UpdateInstantBooking? = nil, proactiveJoin: UpdateProactiveJoin? = nil, requireCheckIn: UpdateRequireCheckIn? = nil, roomUtilizationMetricsEnabled: Bool? = nil) {
            self.endOfMeetingReminder = endOfMeetingReminder
            self.instantBooking = instantBooking
            self.proactiveJoin = proactiveJoin
            self.requireCheckIn = requireCheckIn
    ...
    public struct UpdateProactiveJoin: AWSEncodableShape {
        public let enabledByMotion: Bool
