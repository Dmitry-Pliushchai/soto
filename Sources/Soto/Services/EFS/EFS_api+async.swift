...
extension EFS {
    ...
    public func updateFileSystemProtection(_ input: UpdateFileSystemProtectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> FileSystemProtectionDescription {
        return try await self.client.execute(operation: "UpdateFileSystemProtection", path: "/2015-02-01/file-systems/{FileSystemId}/protection", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
