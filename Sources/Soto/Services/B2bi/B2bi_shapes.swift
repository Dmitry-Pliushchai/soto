...
extension B2bi {
    ...
    public struct DeleteCapabilityRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "capabilityId", location: .uri("capabilityId"))
        ]
    ...
    public struct DeletePartnershipRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "partnershipId", location: .uri("partnershipId"))
        ]
    ...
    public struct DeleteTransformerRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "transformerId", location: .uri("transformerId"))
        ]
    ...
    public struct GetTransformerJobRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "transformerId", location: .querystring("transformerId")),
            AWSMemberEncoding(label: "transformerJobId", location: .uri("transformerJobId"))
        ]
    ...
    public struct ListPartnershipsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "profileId", location: .querystring("profileId"))
        ]
