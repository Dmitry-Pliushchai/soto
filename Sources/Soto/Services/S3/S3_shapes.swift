...
extension S3 {
    ...
    public struct CreateSessionRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "bucket", location: .uri("Bucket")),
            AWSMemberEncoding(label: "sessionMode", location: .header("x-amz-create-session-mode"))
        ]
    ...
    public struct HeadBucketOutput: AWSDecodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "accessPointAlias", location: .header("x-amz-access-point-alias")),
            AWSMemberEncoding(label: "bucketLocationName", location: .header("x-amz-bucket-location-name")),
            AWSMemberEncoding(label: "bucketLocationType", location: .header("x-amz-bucket-location-type")),
            AWSMemberEncoding(label: "bucketRegion", location: .header("x-amz-bucket-region"))
        ]
        ...
        private enum CodingKeys: String, CodingKey {
            case accessPointAlias = "x-amz-access-point-alias"
            case bucketLocationName = "x-amz-bucket-location-name"
            case bucketLocationType = "x-amz-bucket-location-type"
            case bucketRegion = "x-amz-bucket-region"
        }
    }
    ...
    public struct ListDirectoryBucketsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "continuationToken", location: .querystring("continuation-token")),
            AWSMemberEncoding(label: "maxDirectoryBuckets", location: .querystring("max-directory-buckets"))
        ]
