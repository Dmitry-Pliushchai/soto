...
extension SFN {
    ...
    public func redriveExecution(_ input: RedriveExecutionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RedriveExecutionOutput {
        return try await self.client.execute(operation: "RedriveExecution", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func testState(_ input: TestStateInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> TestStateOutput {
        return try await self.client.execute(operation: "TestState", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "sync-", logger: logger, on: eventLoop)
    }
