...
public struct SFN: AWSService {
    ...
    public func redriveExecution(_ input: RedriveExecutionInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RedriveExecutionOutput> {
        return self.client.execute(operation: "RedriveExecution", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func testState(_ input: TestStateInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestStateOutput> {
        return self.client.execute(operation: "TestState", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "sync-", logger: logger, on: eventLoop)
    }
