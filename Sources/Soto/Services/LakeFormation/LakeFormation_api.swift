...
public struct LakeFormation: AWSService {
    ...
    public func getDataCellsFilter(_ input: GetDataCellsFilterRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDataCellsFilterResponse> {
        return self.client.execute(operation: "GetDataCellsFilter", path: "/GetDataCellsFilter", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listLakeFormationOptIns(_ input: ListLakeFormationOptInsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListLakeFormationOptInsResponse> {
        return self.client.execute(operation: "ListLakeFormationOptIns", path: "/ListLakeFormationOptIns", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateDataCellsFilter(_ input: UpdateDataCellsFilterRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDataCellsFilterResponse> {
        return self.client.execute(operation: "UpdateDataCellsFilter", path: "/UpdateDataCellsFilter", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
...
extension LakeFormation {
    ...
    ///   - onPage: closure called with each paginated response. It combines an accumulating result with the contents of response. This combined result is then returned
    ///         along with a boolean indicating if the paginate operation should continue.
    public func listLakeFormationOptInsPaginator<Result>(
        _ input: ListLakeFormationOptInsRequest,
        _ initialValue: Result,
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (Result, ListLakeFormationOptInsResponse, EventLoop) -> EventLoopFuture<(Bool, Result)>
    ) -> EventLoopFuture<Result> {
        return self.client.paginate(
            input: input,
            initialValue: initialValue,
    ...
    public func listLakeFormationOptInsPaginator(
        ...
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListLakeFormationOptInsResponse, EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
        return self.client.paginate(
            input: input,
            command: self.listLakeFormationOptIns,
