...
extension BedrockRuntime {
    ...
    public struct InvokeModelRequest: AWSEncodableShape & AWSShapeWithPayload {
        ...
        public init(accept: String? = nil, body: AWSPayload, contentType: String? = nil, modelId: String) {
            self.accept = accept
            self.body = body
    ...
    public struct InvokeModelResponse: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "body"
        public static let _options: AWSShapeOptions = [.rawPayload]
        public static var _encoding = [
        ...
        public init(body: AWSPayload, contentType: String) {
            self.body = body
            self.contentType = contentType
        }
    ...
    public struct InvokeModelWithResponseStreamRequest: AWSEncodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "body"
        public static let _options: AWSShapeOptions = [.rawPayload]
        public static var _encoding = [
            AWSMemberEncoding(label: "accept", location: .header("X-Amzn-Bedrock-Accept")),
            AWSMemberEncoding(label: "contentType", location: .header("Content-Type")),
            AWSMemberEncoding(label: "modelId", location: .uri("modelId"))
        ]
    ...
    public struct InvokeModelWithResponseStreamResponse: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "body"
        public static var _encoding = [
            AWSMemberEncoding(label: "contentType", location: .header("X-Amzn-Bedrock-Content-Type"))
        ]
        ...
        public init(body: ResponseStream, contentType: String) {
            self.body = body
            self.contentType = contentType
        }
        ...
        private enum CodingKeys: String, CodingKey {
            case body = "body"
            case contentType = "X-Amzn-Bedrock-Content-Type"
        }
    }
