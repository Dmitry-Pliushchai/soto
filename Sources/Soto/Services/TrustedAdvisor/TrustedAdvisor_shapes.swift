...
extension TrustedAdvisor {
    ...
    public struct GetOrganizationRecommendationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "organizationRecommendationIdentifier", location: .uri("organizationRecommendationIdentifier"))
        ]
    ...
    public struct GetRecommendationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "recommendationIdentifier", location: .uri("recommendationIdentifier"))
        ]
    ...
    public struct ListChecksRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "awsService", location: .querystring("awsService")),
            AWSMemberEncoding(label: "language", location: .querystring("language")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "pillar", location: .querystring("pillar")),
    ...
    public struct ListOrganizationRecommendationAccountsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "affectedAccountId", location: .querystring("affectedAccountId")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "organizationRecommendationIdentifier", location: .uri("organizationRecommendationIdentifier"))
        ]
    ...
    public struct ListOrganizationRecommendationResourcesRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "organizationRecommendationIdentifier", location: .uri("organizationRecommendationIdentifier")),
            AWSMemberEncoding(label: "regionCode", location: .querystring("regionCode")),
    ...
    public struct ListOrganizationRecommendationsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "afterLastUpdatedAt", location: .querystring("afterLastUpdatedAt")),
            AWSMemberEncoding(label: "awsService", location: .querystring("awsService")),
            AWSMemberEncoding(label: "beforeLastUpdatedAt", location: .querystring("beforeLastUpdatedAt")),
            AWSMemberEncoding(label: "checkIdentifier", location: .querystring("checkIdentifier")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "pillar", location: .querystring("pillar")),
            AWSMemberEncoding(label: "source", location: .querystring("source")),
