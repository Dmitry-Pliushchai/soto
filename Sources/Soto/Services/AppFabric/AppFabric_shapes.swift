...
extension AppFabric {
    ...
    public struct ConnectAppAuthorizationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "appAuthorizationIdentifier", location: .uri("appAuthorizationIdentifier")),
            AWSMemberEncoding(label: "appBundleIdentifier", location: .uri("appBundleIdentifier"))
        ]
    ...
    public struct CreateIngestionDestinationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "appBundleIdentifier", location: .uri("appBundleIdentifier")),
            AWSMemberEncoding(label: "ingestionIdentifier", location: .uri("ingestionIdentifier"))
        ]
    ...
    public struct DeleteIngestionDestinationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "appBundleIdentifier", location: .uri("appBundleIdentifier")),
            AWSMemberEncoding(label: "ingestionDestinationIdentifier", location: .uri("ingestionDestinationIdentifier")),
            AWSMemberEncoding(label: "ingestionIdentifier", location: .uri("ingestionIdentifier"))
        ]
