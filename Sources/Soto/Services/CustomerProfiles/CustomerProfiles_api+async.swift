...
extension CustomerProfiles {
    ...
    public func detectProfileObjectType(_ input: DetectProfileObjectTypeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DetectProfileObjectTypeResponse {
        return try await self.client.execute(operation: "DetectProfileObjectType", path: "/domains/{DomainName}/detect/object-types", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
