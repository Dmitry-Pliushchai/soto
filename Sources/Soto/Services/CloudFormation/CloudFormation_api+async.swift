...
extension CloudFormation {
    ...
    public func activateOrganizationsAccess(_ input: ActivateOrganizationsAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ActivateOrganizationsAccessOutput {
        return try await self.client.execute(operation: "ActivateOrganizationsAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deactivateOrganizationsAccess(_ input: DeactivateOrganizationsAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeactivateOrganizationsAccessOutput {
        return try await self.client.execute(operation: "DeactivateOrganizationsAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeOrganizationsAccess(_ input: DescribeOrganizationsAccessInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeOrganizationsAccessOutput {
        return try await self.client.execute(operation: "DescribeOrganizationsAccess", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listStackInstanceResourceDrifts(_ input: ListStackInstanceResourceDriftsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListStackInstanceResourceDriftsOutput {
        return try await self.client.execute(operation: "ListStackInstanceResourceDrifts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
