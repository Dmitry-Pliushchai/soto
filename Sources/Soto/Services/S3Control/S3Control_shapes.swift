...
extension S3Control {
    ...
    public struct DeleteAccessGrantRequest: AWSEncodableShape {
        public static let _options: AWSShapeOptions = [.checksumRequired]
        public static var _encoding = [
            AWSMemberEncoding(label: "accessGrantId", location: .uri("AccessGrantId")),
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId"))
        ]
    ...
    public struct DeleteAccessGrantsLocationRequest: AWSEncodableShape {
        public static let _options: AWSShapeOptions = [.checksumRequired]
        public static var _encoding = [
            AWSMemberEncoding(label: "accessGrantsLocationId", location: .uri("AccessGrantsLocationId")),
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId"))
        ]
    ...
    public struct GetAccessGrantsInstanceForPrefixRequest: AWSEncodableShape {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId")),
            AWSMemberEncoding(label: "s3Prefix", location: .querystring("s3prefix"))
        ]
    ...
    public struct GetDataAccessRequest: AWSEncodableShape {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId")),
            AWSMemberEncoding(label: "durationSeconds", location: .querystring("durationSeconds")),
            AWSMemberEncoding(label: "permission", location: .querystring("permission")),
            AWSMemberEncoding(label: "privilege", location: .querystring("privilege")),
    ...
    public struct GetStorageLensGroupResult: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "storageLensGroup"
        public static var _encoding = [
            AWSMemberEncoding(label: "storageLensGroup", location: .body("StorageLensGroup"))
        ]

        /// The name of the Storage Lens group that you're trying to retrieve the configuration details for.
        public let storageLensGroup: StorageLensGroup?

        public init(storageLensGroup: StorageLensGroup? = nil) {
            self.storageLensGroup = storageLensGroup
        }
    ...
    public struct ListAccessGrantsLocationsRequest: AWSEncodableShape {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId")),
            AWSMemberEncoding(label: "locationScope", location: .querystring("locationscope")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken"))
        ]
    ...
    public struct ListAccessGrantsRequest: AWSEncodableShape {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "accountId", location: .header("x-amz-account-id")),
            AWSMemberEncoding(label: "accountId", location: .hostname("AccountId")),
            AWSMemberEncoding(label: "applicationArn", location: .querystring("application_arn")),
            AWSMemberEncoding(label: "granteeIdentifier", location: .querystring("granteeidentifier")),
            AWSMemberEncoding(label: "granteeType", location: .querystring("granteetype")),
            AWSMemberEncoding(label: "grantScope", location: .querystring("grantscope")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "permission", location: .querystring("permission"))
        ]
