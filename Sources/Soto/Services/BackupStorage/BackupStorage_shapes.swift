...
extension BackupStorage {
    ...
    public struct PutChunkInput: AWSEncodableShape & AWSShapeWithPayload {
        ...
        public init(backupJobId: String, checksum: String, checksumAlgorithm: DataChecksumAlgorithm, chunkIndex: Int64, data: AWSPayload, length: Int64 = 0, uploadId: String) {
            self.backupJobId = backupJobId
            self.checksum = checksum
            self.checksumAlgorithm = checksumAlgorithm
