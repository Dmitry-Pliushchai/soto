...
extension Rekognition {
    ...
    public func getMediaAnalysisJob(_ input: GetMediaAnalysisJobRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetMediaAnalysisJobResponse {
        return try await self.client.execute(operation: "GetMediaAnalysisJob", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listMediaAnalysisJobs(_ input: ListMediaAnalysisJobsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListMediaAnalysisJobsResponse {
        return try await self.client.execute(operation: "ListMediaAnalysisJobs", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startMediaAnalysisJob(_ input: StartMediaAnalysisJobRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartMediaAnalysisJobResponse {
        return try await self.client.execute(operation: "StartMediaAnalysisJob", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
