...
extension BedrockAgentRuntime {
    ...
    public struct InvokeAgentResponse: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "completion"
        public static var _encoding = [
            AWSMemberEncoding(label: "contentType", location: .header("x-amzn-bedrock-agent-content-type")),
            AWSMemberEncoding(label: "sessionId", location: .header("x-amz-bedrock-agent-session-id"))
        ]

        /// Inference response from the model in the format specified in the Content-Type response header.
        public let completion: ResponseStream
        /// streaming response mimetype of the model
        public let contentType: String
        /// streaming response mimetype of the model
        public let sessionId: String

        public init(completion: ResponseStream, contentType: String, sessionId: String) {
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case contentType = "x-amzn-bedrock-agent-content-type"
            case sessionId = "x-amz-bedrock-agent-session-id"
        }
    }
