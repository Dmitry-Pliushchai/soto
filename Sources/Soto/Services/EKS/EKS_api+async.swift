...
extension EKS {
    ...
    public func createEksAnywhereSubscription(_ input: CreateEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateEksAnywhereSubscriptionResponse {
        return try await self.client.execute(operation: "CreateEksAnywhereSubscription", path: "/eks-anywhere-subscriptions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPodIdentityAssociation(_ input: CreatePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreatePodIdentityAssociationResponse {
        return try await self.client.execute(operation: "CreatePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteEksAnywhereSubscription(_ input: DeleteEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteEksAnywhereSubscriptionResponse {
        return try await self.client.execute(operation: "DeleteEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deletePodIdentityAssociation(_ input: DeletePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeletePodIdentityAssociationResponse {
        return try await self.client.execute(operation: "DeletePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeEksAnywhereSubscription(_ input: DescribeEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeEksAnywhereSubscriptionResponse {
        return try await self.client.execute(operation: "DescribeEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describePodIdentityAssociation(_ input: DescribePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribePodIdentityAssociationResponse {
        return try await self.client.execute(operation: "DescribePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listEksAnywhereSubscriptions(_ input: ListEksAnywhereSubscriptionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListEksAnywhereSubscriptionsResponse {
        return try await self.client.execute(operation: "ListEksAnywhereSubscriptions", path: "/eks-anywhere-subscriptions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listPodIdentityAssociations(_ input: ListPodIdentityAssociationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListPodIdentityAssociationsResponse {
        return try await self.client.execute(operation: "ListPodIdentityAssociations", path: "/clusters/{clusterName}/pod-identity-associations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateEksAnywhereSubscription(_ input: UpdateEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateEksAnywhereSubscriptionResponse {
        return try await self.client.execute(operation: "UpdateEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updatePodIdentityAssociation(_ input: UpdatePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdatePodIdentityAssociationResponse {
        return try await self.client.execute(operation: "UpdatePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
