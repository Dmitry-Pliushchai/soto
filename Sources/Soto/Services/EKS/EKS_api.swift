...
public struct EKS: AWSService {
    ...
    public func createEksAnywhereSubscription(_ input: CreateEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateEksAnywhereSubscriptionResponse> {
        return self.client.execute(operation: "CreateEksAnywhereSubscription", path: "/eks-anywhere-subscriptions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createPodIdentityAssociation(_ input: CreatePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePodIdentityAssociationResponse> {
        return self.client.execute(operation: "CreatePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteEksAnywhereSubscription(_ input: DeleteEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteEksAnywhereSubscriptionResponse> {
        return self.client.execute(operation: "DeleteEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deletePodIdentityAssociation(_ input: DeletePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeletePodIdentityAssociationResponse> {
        return self.client.execute(operation: "DeletePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeEksAnywhereSubscription(_ input: DescribeEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEksAnywhereSubscriptionResponse> {
        return self.client.execute(operation: "DescribeEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describePodIdentityAssociation(_ input: DescribePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribePodIdentityAssociationResponse> {
        return self.client.execute(operation: "DescribePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listEksAnywhereSubscriptions(_ input: ListEksAnywhereSubscriptionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEksAnywhereSubscriptionsResponse> {
        return self.client.execute(operation: "ListEksAnywhereSubscriptions", path: "/eks-anywhere-subscriptions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listPodIdentityAssociations(_ input: ListPodIdentityAssociationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPodIdentityAssociationsResponse> {
        return self.client.execute(operation: "ListPodIdentityAssociations", path: "/clusters/{clusterName}/pod-identity-associations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateEksAnywhereSubscription(_ input: UpdateEksAnywhereSubscriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateEksAnywhereSubscriptionResponse> {
        return self.client.execute(operation: "UpdateEksAnywhereSubscription", path: "/eks-anywhere-subscriptions/{id}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updatePodIdentityAssociation(_ input: UpdatePodIdentityAssociationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdatePodIdentityAssociationResponse> {
        return self.client.execute(operation: "UpdatePodIdentityAssociation", path: "/clusters/{clusterName}/pod-identity-associations/{associationId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
...
extension EKS {
    ...
    ///   - onPage: closure called with each paginated response. It combines an accumulating result with the contents of response. This combined result is then returned
    ///         along with a boolean indicating if the paginate operation should continue.
    public func listEksAnywhereSubscriptionsPaginator<Result>(
        _ input: ListEksAnywhereSubscriptionsRequest,
        _ initialValue: Result,
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (Result, ListEksAnywhereSubscriptionsResponse, EventLoop) -> EventLoopFuture<(Bool, Result)>
    ) -> EventLoopFuture<Result> {
        return self.client.paginate(
            input: input,
            initialValue: initialValue,
    ...
    public func listEksAnywhereSubscriptionsPaginator(
        ...
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListEksAnywhereSubscriptionsResponse, EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
        return self.client.paginate(
            input: input,
            command: self.listEksAnywhereSubscriptions,
    ...
    ///   - onPage: closure called with each paginated response. It combines an accumulating result with the contents of response. This combined result is then returned
    ///         along with a boolean indicating if the paginate operation should continue.
    public func listPodIdentityAssociationsPaginator<Result>(
        _ input: ListPodIdentityAssociationsRequest,
        _ initialValue: Result,
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (Result, ListPodIdentityAssociationsResponse, EventLoop) -> EventLoopFuture<(Bool, Result)>
    ) -> EventLoopFuture<Result> {
        return self.client.paginate(
            input: input,
            initialValue: initialValue,
    ...
    public func listPodIdentityAssociationsPaginator(
        ...
        logger: Logger = AWSClient.loggingDisabled,
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListPodIdentityAssociationsResponse, EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
        return self.client.paginate(
            input: input,
            command: self.listPodIdentityAssociations,
