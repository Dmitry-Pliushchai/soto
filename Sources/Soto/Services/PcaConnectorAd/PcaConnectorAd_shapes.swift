...
extension PcaConnectorAd {
    ...
    public struct CreateServicePrincipalNameRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "directoryRegistrationArn", location: .uri("DirectoryRegistrationArn"))
        ]
    ...
    public struct DeleteTemplateGroupAccessControlEntryRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "groupSecurityIdentifier", location: .uri("GroupSecurityIdentifier")),
            AWSMemberEncoding(label: "templateArn", location: .uri("TemplateArn"))
        ]
    ...
    public struct ListTemplatesRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "connectorArn", location: .querystring("ConnectorArn")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("MaxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("NextToken"))
        ]
